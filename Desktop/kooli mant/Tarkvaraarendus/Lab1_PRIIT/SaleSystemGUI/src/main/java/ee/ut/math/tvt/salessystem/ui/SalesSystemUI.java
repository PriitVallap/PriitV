...
public class SalesSystemUI extends Application {
    ...
    public SalesSystemUI() {
        ...
        this.soldItems = dao.findSoldItems();
        shoppingCart = new ShoppingCart(dao);
    }

    @Override
    public void start(Stage primaryStage) throws Exception {
        log.info("SalesSystemUI is started.");
    ...
    private Node loadControls(String fxml, Initializable controller) throws IOException {
        ...
        fxmlLoader.setResources(ResourceBundle.getBundle("application", Locale.getDefault()));
        log.info("Controls are loaded.");
